...
if(isset($_GET['type'])){
    ...
    if($type=='sports'){
        ...
        $cat="Reptile Party";
    }elseif ($type=='super_scientist'){
        $cat="Super Scientist Party";
    }elseif ($type=='dance'){
        $cat="Dance Party";
    ...
    $stm = $con->prepare("select * from packages where type='Parties' and category='$cat'");
    $stm->execute();
            ...
            <div class="kss-col1 col-md-10">
                ...
                <div class="kss-header">
                    ...
                    <div class="pull-right">
                        ...
                        <br>
                        <a href="parties.php" class="back-btn BackClick">Back</a>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 cbox" style="z-index: 10;color: black;">
                               ...
                               <div class="col-sm-3 catTitle">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group" >
                                        <label style="font-weight: 400;" >Package</label><br>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 packageInfo">
                            <div class="col-md-8 ">
                                ...
                                <div class="col-md-2 packageBox p-children" data-title="NUMBER OF CHILDREN" data-description="">NUMBER OF CHILDREN
                                </div>
                                <div class="col-md-2 packageBox p-location" data-title="LOCATION" data-description="">LOCATION
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-md-2 packageBox p-conditions" data-title="Conditions" data-description="no conditions" style="font-size: 12px;">Conditions
                                </div>
                                <div class="col-md-2 packageBox p-fees" data-title="fees" data-description="">fees
                                </div>
                                <div class="col-md-2 packageBox p-weather" data-title="weather policy" data-description="WEATHER POLICY If your party is cancelled by KSS due to weather or power-related issues, you have the choice to use your already-paid funds towards re-scheduling your party at the next available date of your choice or towards any class or activity. Or, you may get a refund, minus the $100 deposit." >weather policy
                                </div>
                        ...
                        <div class="col-md-12" align="center" style="text-transform: none">
                            <br>
                ...
                success	: function (resp) {
                    if(resp.success) {
                        if(resp.data){
                            ...
                            $(".p-children").attr('data-description',resp.data['num_of_children']);
                            $(".p-location").attr('data-description',resp.data['location']);
                            $(".p-conditions").attr('data-description',resp.data['terms_conditions']);
