...
<th  class="">Booked Date</th>
                                ...
                                <tbody>
                                    <?php foreach ($FormData as $trn){
                                        ...
                                        //var_dump($trn['shipping_address']);
                                       //$data=(array)json_decode($trn['shipping_address']);
                                         //print_r($data);
 ...
 <td><?php echo $trn['entry_date'];?></td>
                                        ...
                                        <td><?php echo $trn['classes_type'];?></td>
                    ...
                    var oTable = table.dataTable({
                        ...
                        "tableTools": {
                            ...
                            "aButtons": [{
                                "sExtends": "pdf",
                                "sButtonText": "PDF",
                                "sFileName":"kss-classes-orders.pdf",
                                "sTitle": "Kss Classes Booked"
                            }, {
                                "sExtends": "csv",
                                "sButtonText": "CSV",
                                "sFileName":"kss-classes-orders.csv",
                                "sTitle": "Kss Classes Booked"
                            }, {
                                "sExtends": "xls",
                                "sButtonText": "Excel",
                                "sFileName":"kss-classes-orders.xls",
                                "sTitle": "Kss Classes Booked"
                            }]
                        }
                    });
