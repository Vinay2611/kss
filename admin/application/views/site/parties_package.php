            ...
            <div id="panel-1" class="panel panel-default">
                <div class="panel-heading">
                    <span class="elipsis"><!-- panel title -->
                        <strong><?php echo isset($_GET['id'])?'Update':'Add'?> Parties Package</strong>
                    </span>
                    <!-- right options -->
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        <option <?php echo isset($FormData['category']) && $FormData['category']=='Sports Party'?'selected':'';?> value="Sports Party">Sports Parties</option>
                                        <option <?php echo isset($FormData['category']) && $FormData['category']=='Reptile Party'?'selected':'';?> value="Reptile Party">Reptile Party</option>
                                        <option <?php echo isset($FormData['category']) && $FormData['category']=='Super Scientist Party'?'selected':'';?> value="Creative Arts">Super Scientist Party</option>
                                        <option <?php echo isset($FormData['category']) && $FormData['category']=='Dance Party'?'selected':'';?> value="Performing Arts">Dance Party</option>
                                        <option <?php echo isset($FormData['category']) && $FormData['category']=='Birthday Party'?'selected':'';?> value="Birthday Party">Birthday Party</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <textarea class="summernote location" id="location" name="location"><?php echo isset($FormData['location'])?$FormData['location']:''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <textarea class="summernote terms_conditions" id="terms_conditions" name="terms_conditions"><?php echo isset($FormData['terms_conditions'])?$FormData['terms_conditions']:''; ?></textarea>
                            </div>
                        </div>
                    </div>
    ...
    $(function () {
        ...
        $("#RecordForm").submit(function (e) {
           ...
           $(".summernote").each(function(){
            ...
            $.ajax({
                type: "POST",
                url: "AddPartiesPackage",
                dataType: 'json',
                data:$(this).serialize(),
                success: function (resp) {
                    if (resp.success) {
                        _toastr(resp.msg,"bottom-right","success",false);
                        location.href="parties_package";
                    } else {
