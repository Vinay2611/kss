...
<th  class="">Booked Date</th>
                                ...
                                <?php foreach ($FormData as $trn){
                                    ?>
                                    <tr>
                                        <td><?php echo $trn['date_from']."-".$trn['date_to'];?></td>
                    ...
                    var oTable = table.dataTable({
                        ...
                        "tableTools": {
                            ...
                            "aButtons": [{
                                "sExtends": "pdf",
                                "sButtonText": "PDF",
                                "sFileName":"kss-parties-orders.pdf",
                                "sTitle": "Kss Parties Booked"
                            }, {
                                "sExtends": "csv",
                                "sButtonText": "CSV",
                                "sFileName":"kss-parties-orders.csv",
                                "sTitle": "Kss Parties Booked"
                            }, {
                                "sExtends": "xls",
                                "sButtonText": "Excel",
                                "sFileName":"kss-parties-orders.xls",
                                "sTitle": "Kss Parties Booked"
                            }]
                        }
                    });
