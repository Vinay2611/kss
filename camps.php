<?php include_once "head.php";?>
    <style>
        ...
        .kss-parties .cbox span{
            font-family: Broadway;
            size: 26px;
        }
        .kss-parties .save-btn{
            padding: 6px 30px;
            ...
            <div class="kss-col1 col-md-10">
                ...
                <div class="kss-header">
                    ...
                    <div class="pull-right">
                        ...
                        <br>
                        <a href="parties-camps.php" class="back-btn BackClick">Back</a>
                    </div>
                </div>
                ...
                <div class="kss-content">
                    ...
                    <div class="col-sm-12 cbox" style="z-index:10;color: black;">
                        <div class="col-md-offset-3 col-md-6 col-sm-6 col-xs-12" style="text-align: center;">
                            <p style="margin-bottom: 2%;text-transform: none">
                                Throughout the year we offer<br> a wide variety of <span>CAMPS</span>!<br> ...parent teacher conference camps,<br> spring break camps or summer camps!<br> We offer a lot of <span>FUN</span> and <span>JOY</span> to your children!
                            </p>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <a href="experiences.php" class="save-btn">Experiances</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="gallery.php" class="save-btn">Gallery</a>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-2 hidden-xs" style="text-align: right">
                            <div style="font-family: Broadway;">
                                <div style="font-size: 30px;">Share</div>
                                <div style="font-size: 22px;margin-left: 14px;">Play</div>
                                <div style="font-size: 16px;    margin-right: 48px;">fun</div>
                        ...
                        <div class="col-md-9 col-sm-9 col-sm-offset-1">
                            ...
                            <a href="book_camps.php?type=season"> <div class="col-md-2 col-sm-2 col-xs-4 white-btn">Camps By Season</div></a>
                            <a href="book_camps.php?type=date"> <div class="col-md-2 col-sm-2 col-xs-4 white-btn">Camps By Date</div></a>
                            <a href="book_camps.php?type=school"> <div class="col-md-2 col-sm-2 col-xs-4  white-btn">Camps By School</div></a>
                            <a href="book_camps.php?type=location"> <div class="col-md-2 col-sm-2 col-xs-4  white-btn">Camps by Location</div></a>
                            <div class="clearfix"></div><br>
                            <br>
                            <p style="text-align: center; text-transform: none;">
                                We work to ensure what the best options for<br> <span class="bway">ENTERTAINMENT</span> and<span class="bway"> LEARNING</span> for your children are.

                            </p>
                            <div class="col-sm-12" align="center" style="font-size: 14px;text-transform: none"> <br>
                                For more information about parties please email<br>
                                <a href="mailto:info@kssprograms.com">info@kssprograms.com</a>
                            </div>
                        </div>
